...
if __name__ == "__main__":
    ...
    os.environ["GAZEBO_MODEL_PATH"] = os.path.join(current_dir, "../models/iris/quadcopter_model")
    os.environ['GAZEBO_RESOURCE_PATH'] = os.path.join(current_dir, "../models/iris/quadcopter")
